class Game{
    ...
    start(){
    kid = createSprite(600, 980, 50, 50);
    kid.addImage("kid", kid_img);
    kid.scale = 0.7;

    if(score % 100 === 0){
    book = createSprite(30, 390, 10, 10);
    ...
    if(score % 200 === 0){
    crayon = createSprite(60, 390, 10, 10);
    ...
    if(score % 300 === 0){
    backpack = createSprite(90, 390, 10, 10);
    ...
    if(score % 300 === 0){
    bottle = createSprite(120, 390, 10, 10);
    ...
    if(score % 300 === 0){
    computer = createSprite(150, 390, 10, 10);
    ...
    if(score % 300 === 0){
    phone = createSprite(180, 390, 10, 10);
    ...
    if(score % 300 === 0){
    camera = createSprite(310, 390, 10, 10);
    ...
    if(score % 300 === 0){
    headphone = createSprite(340, 390, 10, 10);
